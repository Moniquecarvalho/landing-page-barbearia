            ...
            <div className="max-w-1440px mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex space-x-4">
                        <a href="#" className="hover:text-yellow-primary transition-colors duration-300">Instagram</a>
                        <a href="#" className="hover:text-yellow-primary transition-colors duration-300">Facebook</a>
                    </div>
                </div>
            </div>
        </footer>
